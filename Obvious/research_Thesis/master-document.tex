...
\title{Modelling the Spread of Zika Virus on a Small World Network}
% Your name must be in CAPITAL with no comma, 
% and the Family name comes last.
\author{By\\ [1cm]
Obvious Nchimunya Chilyabanyama  (obvious.chilyabanyama@aims.ac.rw)\\
...
% University of Stellenbosch, South Africa
{\small Supervised by: Professor Nancy Ann Neudauer}\\
{\small Pacific University, USA}%
...
\newcommand{\Onote}{\Authornote{Obvious}}
%-------------------------------------------------------------------------
\begin{document}
...
\input{chapter5}
\input{appendixA} % You may have more chapters. (Use e.g. git add FILE)
