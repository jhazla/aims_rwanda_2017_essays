...
\Jnote{Please do not address the reader directly (``you'').
Also you are repeating yourself in some of the points.}
...
\Jnote{I did not understand this paragraph at all.}
...
Figure \ref{json}
\Jnote{Please acknowledge the source of the figure.}
...
\Jnote{I think this example is pretty interesting. Consider adding
  more. For example, it would be interesting to see an instance
  where the algorithms are not 100\% correct and understand why.
  That way you wouldn't have to worry about inflating number of pages
  with \textbackslash newpage...}