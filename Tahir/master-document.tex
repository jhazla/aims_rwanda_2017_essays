...
\usepackage{lineno}
\usepackage{physics}
\newcommand{\head}[1]{\textnormal{\text{#1}}}
\newtheorem{theorem}{Theorem}
\newtheorem{lemma}[theorem]{Lemma} % This package together with lineno.sty numbers every line. Makes it easy for edditing.
\usepackage{footnote}
...
\title{Different Approaches to Quantum Non-Locality}
% Your name must be in CAPITAL with no comma, 
% and the Family name comes last.
\author{By\\ [1cm]
Tahir Mohammed Elamin Adreani  (tahir.adreani@aims.ac.rw)\\
