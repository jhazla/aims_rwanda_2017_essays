...
\Jnote{Novel is a type of book, you mean something else.} This work incorporates the selectional preferences for words argument position. With this it is possible to integrate syntax computation of word meaning in context. \Jnote{I don't understand at all,
...
To achieve document similarity computing the dot product of the row vectors yields desired results. \Jnote{I don't understand last sentence, please explain better.}
...
\Jnote{Please don't copy sentences from papers. I hope you can explain to me:
  What is n-gram statistic? What is latent topic variable? What is
  uni-gram topic model? What is a hierarchical Dirichlet model?}
