...
Hadron colliders are devices made to explore the world of particle physics, they work as theory testers and also as  discovery machines, an example of these hadron colliders is the Large Hadron Collider (LHC) at CERN \citep{1748-0221-3-08-S08001}.
Inside the Large Hadron Collider, $10^{11}$ protons are being accelerated to a high kinetic energy and then collided up 40 million times per second to provide 14 \si{TeV} proton-proton collision. The LHC also collides heavy ions. Two general purpose detectors, ATLAS (A Toroidal LHC Apparatus) \cite{Aad:2008zzm} and CMS (Compact Muon Solenoid) \cite{1748-0221-3-08-S08004} have been built primarily for probing proton-proton collisions.
 
Most of the interesting physics at the LHC involves studying the results of these interactions (collisions). Among the main missions of the LHC is the investigation of the properties of the Higgs boson. The importance of the Higgs boson stems from investigating the validity of the Standard Model and suggests that the masses of the elementary particles are generated through the Higgs mechanism \citep{particle}. In July 2012, the ATLAS and CMS experiments at CERN's Large Hadron Collider announced that they have had each observed new particle in the mass region around 126 GeV \citep{Aad:2012tfa}. This particle is consistent with the Higgs boson predicted by the standard model. It has been observed that as a result of these collisions, partons are formed, partons consists of quarks and gluons. From the experimental point of view, these collisions lead to the production of partons alongside the production of another particles like the \emph{(Higgs)} boson. However, these partons are not detected.
...
There are six "flavours" of quarks, these are: up, down, charm, strange, top and bottom. Quarks carry colour charge: red, green or blue, the colour name here is an analogy  that is famously used among physicists to describe a three kind of generating force. The colour charges are called by their number or any other index. We can also we think of it as a three primary additive colours. 
Quarks can successfully account for all known mesons and baryons which are known as hadrons, hadrons are colour charge neutral particles. The other partons (gluons)  mediate the interaction between quarks. Gluon is a massless spin $1$ particle, carrying charge called colour charges similar to the quarks, because  of the colour charge gluons can interact among themselves. 
...
The theory that describes the colour charge of the quarks and gluons is called \emph{(Quantum Chromodynamics)}. The colour charge has a unique property that it exerts a constant force that binds colour carrying particles together, this can be visualized using the analogy of a rubber band, the stronger you pull on the rubber band the tighter it feels.
If we do not pull on it at all, it hangs loose. The same thing happens for these particles,  meaning that at a very short distance, the force is relaxed and the particles behave as free particles. As the distance between them increases, the force acts like a rubber band and pulls them back stronger. When the rubber band is stretched beyond its limits, it breaks into many pieces producing more particles. This phenomenon is known as the colour confinement. In other words, these particles tend not to be separated by a macroscopic distance
 \citep{particle}.

%The theory which describes this force is called $Quantum$ $Chromodynamics$ \citep{particle}.
Due to the complex nature of the event at the large hadron collider, where the description of the final state involves a multi-particle calculations. Monte Carlo event generators provide a good approximation of these collisions.\label{sec}
