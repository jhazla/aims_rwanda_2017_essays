...
% University of Stellenbosch, South Africa
{\small Supervised by: Dr. Samuel Meehan}\\
{\small CERN, Switzerland}%
...
\newcommand{\Knote}{\Authornote{Khalid}}
% -------------------------------------------------------------------------
...
\input{chapter2}%the parton shower model 

\input{chapter3} % the parton shower

\input{chapter4} % Chapters might go from 2. problem statement, 
                 % through 3. model, to 4. analysis & results
\input{chapter5} % You do not need to have exactly 4 chapters.
                 % It is probably a good minimum, with 5 chapters 
                 % average, and 7 chapters might be a maximum.
\input{chapter6} % Conclusion is usually a chapter itself. 
