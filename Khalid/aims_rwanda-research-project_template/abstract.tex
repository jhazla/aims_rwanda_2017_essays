...
%\Jnote{Rephrase to sth like: ``However, we cannot  detect them directly.''}
...
%\Jnote{In order to understand what. I would add a sentence or two and rephrase.
%  Last sentence not grammatical.}

%\Jnote{Please summarize what your thesis does in a sentence or two.}
