...
%\Jnote{No, it does not. The bounds from theorem by Raz are not comparable   to those ones.}
...
As $b_j \in K$, strategies $F^1, \ldots, F^k$ win in  the $l-$th copy of $G$. That is the game $G$ is not trivial. %\Jnote{It is trivial.}
...
\begin{proof}
Let $\bar{b}=(b_1,\ldots, b_n)$ an element of the combinatorial line $L
\end{proof}
