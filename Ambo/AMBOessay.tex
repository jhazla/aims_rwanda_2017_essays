...
\title{Connection between parallel repetition of multi-prover games and the  Hales-Jewett theorem}
% Your name must be in CAPITAL with no comma, 
% and the Family name comes last.
\author{By\\ [1cm]
Jean-M\'edard Ambo Amandure   (jeanmedard.ambo@aims.ac.rw)\\
...
% Example2
%Supervised by Doctor Jan Hązła
% University of Stellenbosch, South Africa
{\small Supervised by: Doctor Jan Hązła}\\
{\small African Institute of Mathematical Sciences, Rwanda}%
...
\newcommand{\Anote}{\Authornote{Ambo}}
%-------------------------------------------------------------------------
\begin{document}
