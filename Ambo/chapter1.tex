...
\Jnote{When you just say ``prover game'' it is not clear if it means two or
  multiple provers. I would say ``two-prover'' or ``multi-prover'' everywhere.}
...
additive combinatorics  as  \say{\textit{ a marriage of number theory, harmonic analysis, combinatorics, and ideas from ergodic theory, which aims to understand very simple systems:  the operations of addition and multiplication and how they interact}}.

\Jnote{Please mention more about additive combinatorics, at least
  VdW and Szemeredi's theorems.}
