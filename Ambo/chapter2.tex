...
There are four important theorems we have talked about: the Van der Waerden's theorem \eqref{vd1}, the Szemerédi's theorem \eqref{sz1}, the  Hales-Jewett theorem \eqref{hj1} and the density Hales-Jewett theorem \eqref{hj2}. 
...
%\Jnote{Your explanation so far was good, but you are not finished yet.   You are proving VdW, so you have $k$ and $r$.  What $k$ and $r$ do you choose for HJ (the same, but you have to say it).   What is $N_0$ that you get for VdW in terms of $HJ(k, r)$?}
